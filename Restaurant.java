...
public class Restaurant {
	...
	public static void main(String[] args) {
		...
		String[] item = new String[] { "Veg-Biryani", "Butter-Naan",
				"Tomato-Soup", "Manchurian", "Fried-Rice",
				"Ice-Cream\t", "Apple-Juice", "tea\t", "coffee\t", "Quit\t" };
		...
		do {
			...
			if (ch > 0 && ch < 10) {
				System.out.println("\t    Enter the no of quantites of " 
			+ item[ch - 1]);
				int q = input.nextInt();
				quantity[ch - 1] += q;
